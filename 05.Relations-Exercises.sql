...
CREATE TABLE `people` (
    ...
    `passport_id` INT UNIQUE,
		CONSTRAINT fk_people FOREIGN KEY (`passport_id`)
...
`student_id`INT ,
`exam_id` INT,
CONSTRAINT pk_st_exams
PRIMARY KEY (`student_id`, `exam_id`),
CONSTRAINT fk_st_exams
FOREIGN KEY (`student_id`)
REFERENCES `students`(`student_id`),
CONSTRAINT fk_st_exams2
FOREIGN KEY (`exam_id`)
...
CREATE TABLE `students` (
    ...
    `major_id` INT(11),
    CONSTRAINT fk_stud_major FOREIGN KEY (`major_id`)
...
CREATE TABLE `agenda` (
    `student_id` INT(11),
    `subject_id` INT(11),
    CONSTRAINT pk_sub_stud PRIMARY KEY (`student_id` , `subject_id`),
    CONSTRAINT fk_sub_agenda FOREIGN KEY (`subject_id`)
        REFERENCES `subjects` (`subject_id`),
    CONSTRAINT fk_sub_students FOREIGN KEY (`student_id`)
        REFERENCES `students` (`student_id`)
);
...
`student_id` INT(11),
    CONSTRAINT fk_stud_pay FOREIGN KEY (`student_id`)
        REFERENCES `students` (`student_id`)
);
